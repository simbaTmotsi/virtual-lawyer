...
const ClientsList = () => {
  ...
  const clients = [
    { id: 1, name: 'John Doe', email: 'john.doe@example.com', phone: '555-123-4567', activeCases: 2 },
    { id: 2, name: 'Jane Smith', email: 'jane.smith@corp.net', phone: '555-987-6543', activeCases: 1 },
    { id: 3, name: 'Tech Corp Inc.', email: 'legal@techcorp.com', phone: '555-555-5555', activeCases: 1 },
    { id: 4, name: 'Sarah Williams', email: 's.williams@mail.org', phone: '555-111-2222', activeCases: 1 },
  ];
            ...
            <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
              {clients.map((client) => (
                <tr key={client.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300 text-center">{client.activeCases}</td>
