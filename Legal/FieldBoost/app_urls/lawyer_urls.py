...
urlpatterns = [
    ...
    path('legal-research/<int:case_id>/', lawyer_client_views.LegalResearchView.as_view(), name='legal_research'),
    ...
    path('document-analysis/clear-chat/', lawyer_client_views.ClearDocumentAnalysisChatView.as_view(), name='document_analysis_clear_chat'),
